        ...
        <div className="ConversationBar-container">
            <div className="searchbar-head">
                <input
                    ...
                    onChange={(event) => sortConversation(event, listOfConversation)}
                />
            ...
            <div className="user-profile">
                <div className="user-info">
                    <div className="user-avatar">{userData?.username?.charAt(0).toUpperCase() || "U"}</div>
                    <div className="user-name">{userData?.username || "Utilisateur"}</div>
                </div>
